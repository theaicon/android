...
public class Irene extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		exploreButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(final View v) {
				final Intent intent = new Intent(Irene.this, FreebaseDomain.class);
		...
		advancedSearchButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(final View v) {
				final Intent intent = new Intent(Irene.this, FreebaseComplexSearch.class);
